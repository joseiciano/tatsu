  ...
  return (
    <section id="install" className="max-w-3xl mx-auto px-6 py-20">
      ...
      >
        ...
        <div className="text-xs text-ink-500 font-mono">Harness-{VERSION}-arm64.dmg</div>
      </a>

      <div className="mt-4 text-center">
        <a
          href={`https://github.com/frenchie4111/harness/releases/latest/download/Harness-${VERSION}-x64.dmg`}
          className="text-sm text-ink-500 hover:text-ink-300 underline transition-colors"
        >
          On an Intel Mac? Download Harness-{VERSION}-x64.dmg
        </a>
      </div>
