...
export function buildBackend(
  ...
  const api: any = {
    ...
    setDefaultOpencodeTabType: (value: 'xterm' | 'json') =>
      req('config:setDefaultOpencodeTabType', value),
    setDefaultCodexTabType: (value: 'xterm' | 'json') =>
      req('config:setDefaultCodexTabType', value),
